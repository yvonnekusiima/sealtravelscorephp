...
if(isset($_POST['deleteonewayflight']))
{
    $connect = mysqli_connect("localhost", "root", "7762", "sealtravels");

    $id = trim($_POST['id']);

    $deleteflight = "DELETE from onewayflights where Id='$id'";
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        <input name="onewayflights" type="submit" class = "btn btn-primary" value="Click to view oneway flights" style="font-size:13px" /><br /><br />

                                        <div class="form-group">
                                            <input class="search pull-left" placeholder="Search oneway flights" style="font-size:13px" />
                                        ...
                                        <table class="table-hover table-bordered results">
                                            ...
                                            if (isset($_POST['onewayflights']))
                                            {
                                                $connect = mysqli_connect("localhost", "root", "7762", "sealtravels");

                                                $viewonewayflights = mysqli_query($connect, "SELECT * from onewayflights");

                                                while ($records = mysqli_fetch_array($viewonewayflights))
                                                {
                                                    ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input name="editonewayflight" type="submit" value="Edit" class = "btn btn-primary", style = "width:80px; font-size:13px" />
                                                        </td>
                                                        <td>
                                                            <form method="post">
                                                                <input type="hidden" name="id" value="<?php echo "$records[Id]"; ?>" />
                                                                <input name="deleteonewayflight" type="submit" value="Delete" class = "btn btn-primary", style = "width:80px; font-size:13px" />
                                                            </form>
                                                        </td>
                                                    </tr>
                                                    </tbody>
