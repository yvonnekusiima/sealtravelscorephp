...
if(isset($_POST['submitpayment']))
{
    ...
    $payment = "INSERT into paymentinformation (Name, Email, PaymentMethod, CardNumber, CVV, ExpiryDate, Amount) VALUES('$name','$email', '$paymentmethod', '$cardnumber', '$cvv', '$expirydate', '$amount')";

    $execute = mysqli_query($connect, $payment);

    if(isset($execute))
    {
        echo "<script type='text/javascript'>alert('Payment has been submitted');</script>";
    }
    else
    {
        echo "<script type='text/javascript'>alert('Payment has not been submitted');</script>";
    } 
}
...
<body style="background-image: url(); font-family:Heebo; font-size:13px">
