...
if(isset($_POST['bookflight']))
{
    ...
    $bookflight = "INSERT into roundtripflights (Name, Email, TripType, LeavingFrom, GoingTo, Departing, Returning, Adults, Children, FlightType, Airline, TravelClass, Amount) VALUES('$name','$email', '$triptype', '$leavingfrom', '$goingto', '$departing', '$returning', '$adults', '$children', '$flightype', '$airline', '$travelclass', '$amount')";
    ...
    if(isset($execute))
    {
        ...
        header("Location: RoundtripRecordsU.php");
    }
    else
    {
