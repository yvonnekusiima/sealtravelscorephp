...
if(isset($_POST['deleteflightticket']))
{
    $connect = mysqli_connect("localhost", "root", "7762", "sealtravels");

    $id = trim($_POST['id']);

    $deleteflightticket = "DELETE from flighttickets where Id='$id'";

    $execute = mysqli_query($connect, $deleteflightticket);

    if(isset($execute))
    {
        echo "<script type='text/javascript'>alert('Flight ticket deleted');</script>";
    }
    else
    {
        echo "<script type='text/javascript'>alert('Flight ticket not deleted');</script>";
    } 
}
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            ...
                                            <input name="flighttickets" type="submit" class = "btn btn-primary" value="Click to view flight tickets" style="font-size:13px" /><br /><br />

                                            <div class="form-group">
                                                <input class="search pull-left" placeholder="Search flight tickets" style="font-size:13px" />
                                            ...
                                            <table class="table-hover table-bordered results">
                                                ...
                                                if (isset($_POST['flighttickets']))
                                                {
                                                    $connect = mysqli_connect("localhost", "root", "7762", "sealtravels");

                                                    $viewflightticketrecords = mysqli_query($connect, "SELECT * from flighttickets");

                                                    while ($records = mysqli_fetch_array($viewflightticketrecords))
                                                    {
                                                        ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php echo "$records[CheckinOpens]"; ?>
                                                            </td>
                                                            <td>
                                                                <?php echo "$records[Departure]"; ?>
                                                            </td>
                                                            <td>
                                                                <?php echo "$records[Arrival]"; ?>
                                                            </td>
                                                            <td>
                                                                <?php echo "$records[DepartingFrom]"; ?>
                                                            </td>
                                                            <td>
                                                                <?php echo "$records[ArrivingAt]"; ?>
                                                            </td>
                                                            <td>
                                                                <?php echo "$records[DepartureAirport]"; ?>
                                                            </td>
                                                            <td>
                                                                <?php echo "$records[ArrivalAirport]"; ?>
                                                            </td>
                                                            <td>
                                                                <?php echo "$records[Barcode]"; ?>
                                                            </td>
                                                            <td>
                                                                <?php echo "$records[TicketValidity]"; ?>
                                                            </td>
                                                            <td>
                                                                <input name="editflightticket" type="submit" value="Edit" class = "btn btn-primary", style = "width:80px; font-size:13px" />
                                                            </td>
                                                            <td>
                                                                <form method="post">
                                                                    <input type="hidden" name="id" value="<?php echo "$records[Id]"; ?>" />
                                                                    <input name="deleteflighticket" type="submit" value="Delete" class = "btn btn-primary", style = "width:80px; font-size:13px" />
                                                                </form>
                                                            </td>
                                                        </tr>
                                                        </tbody>
