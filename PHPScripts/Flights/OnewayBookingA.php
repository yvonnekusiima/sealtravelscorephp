...
if(isset($_POST['bookflight']))
{
    ...
    $bookflight = "INSERT into onewayflights (Name, Email, TripType, LeavingFrom, GoingTo, Departing, Adults, Children, FlightType, Airline, TravelClass, Amount) VALUES('$name','$email', '$triptype', '$leavingfrom', '$goingto', '$departing', '$adults', '$children', '$flighttype', '$airline', '$travelclass', '$amount')";

    $execute = mysqli_query($connect, $bookflight);

    if(isset($execute))
    {
        echo "<script type='text/javascript'>alert('Flight has been booked');</script>";

        $receiver = "yvonnevanita17@gmail.com";
        $subject = "Flight Booking";
        $message = "Your flight booking has been recieved.\nIf you have not submitted payment please do within 24 hours.\nIf you have submitted your ticket please pick your ticket from our office.";
    ...
    {
        echo "<script type='text/javascript'>alert('Flight has not been booked');</script>";
    } 
}
