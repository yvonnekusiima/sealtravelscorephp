...
if(isset($_POST['deleteflightpayment']))
{
    $connect = mysqli_connect("localhost", "root", "7762", "sealtravels");

    $id = trim($_POST['id']);

    $deleteflightpayment = "DELETE from paymentinformation where Id='$id'";

    $execute = mysqli_query($connect, $deleteflightpayment);
    ...
    {
        echo "<script type='text/javascript'>alert('Flight payment not deleted');</script>";
    } 
}
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            ...
                                            <input name="flightpayments" type="submit" class = "btn btn-primary" value="Click to view flight payments" style="font-size:13px" /><br /><br />

                                            <div class="form-group">
                                                <input class="search pull-left" placeholder="Search flight payments" style="font-size:13px" />
                                            ...
                                            <table class="table-hover table-bordered results">
                                                ...
                                                if (isset($_POST['flightpayments']))
                                                {
                                                    $connect = mysqli_connect("localhost", "root", "7762", "sealtravels");

                                                    $viewflightpaymentrecords = mysqli_query($connect, "SELECT * from paymentinformation");

                                                    while ($records = mysqli_fetch_array($viewflightpaymentrecords))
                                                    {
                                                        ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php echo "$records[PaymentMethod]"; ?>
                                                            </td>
                                                            <td>
                                                                <?php echo "$records[CardNumber]"; ?>
                                                            </td>
                                                            <td>
                                                                <?php echo "$records[CVV]"; ?>
                                                            </td>
                                                            <td>
                                                                <?php echo "$records[ExpiryDate]"; ?>
                                                            </td>
                                                            <td>
                                                                <?php echo "$records[Amount]"; ?>
                                                            </td>
                                                            <td>
                                                                <input name="editflightpayment" type="submit" value="Edit" class = "btn btn-primary", style = "width:80px; font-size:13px" />
                                                            </td>
                                                            <td>
                                                                <form method="post">
                                                                    <input type="hidden" name="id" value="<?php echo "$records[Id]"; ?>" />
                                                                    <input name="deleteflightpayment" type="submit" value="Delete" class = "btn btn-primary", style = "width:80px; font-size:13px" />
                                                                </form>
                                                            </td>
                                                        </tr>
                                                        </tbody>
