...
if(isset($_POST['updateflight']))
{
    ...
    $updateflight = "UPDATE onewayflights set Name = '$name', Email = '$email', TripType = '$triptype', LeavingFrom = '$leavingfrom', GoingTo = '$goingto', Departing = '$departing', Adults = '$adults', Children = '$children', FlightType = '$flighttype', Airline = '$airline', TravelClass = '$travelclass', Amount = '$amount' where Id = $id";
    ...
    if(isset($execute))
    {
        ...
        header("Location: OnewayRecordsU.php");
    }
    else
    {
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="p-5">
                                            <div class="">
                                                <h4 class="" style="color:#4e73df; font-family:Heebo"><strong>Edit a Oneway flight</strong> <i class="fa fa-edit"></i></h4><br />
                                            </div>
                                                        <!--Oneway Booking Form-->
