...
if(isset($_POST['deletehotelbooking']))
{
    ...
    $deletehotel = "DELETE from hotelbooking where Id='$id'";

    $execute = mysqli_query($connect, $deletehotel);
    ...
    {
        echo "<script type='text/javascript'>alert('Hotel booking not deleted');</script>";
    } 
}
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="card-body">
              <div class="table-responsive">
                  ...
                  <input name="hotelbookings" type="submit" class = "btn btn-primary" value="Click to view hotel bookings" style="font-size:13px" /><br /><br />

                  <div class="form-group">
                        <input class="search pull-left" placeholder="Search for hotel booking" style="font-size:13px" />
                      <span class="counter pull-right"></span>
                        ...
                        <table class="table-hover table-bordered results">
                            ...
                            if (isset($_POST['hotelbookings']))
                            {
                                $connect = mysqli_connect("localhost", "root", "7762", "sealtravels");
                                
                                $viewhotelbookings = mysqli_query($connect, "SELECT * from hotelbooking");

                                while ($records = mysqli_fetch_array($viewhotelbookings))
                                { 
                                    ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <?php echo "$records[Travelers]"; ?>
                                        </td>
                                        <td>
                                        <?php echo "$records[Rooms]"; ?>
                                        </td>
                                        <td>
                                        <?php echo "$records[RoomType]"; ?>
                                        </td>
                                        <td>
                                        <?php echo "$records[CheckIn]"; ?>
                                        </td>
                                        <td>
                                        <?php echo "$records[CheckOut]"; ?>
                                        </td>
                                        <td>
                                        <?php echo "$records[Amount]"; ?>
                                        </td>
                                        <td>
                                            <input name="edithotelbooking" type="submit" value="Edit" class = "btn btn-primary", style = "width:80px; font-size:13px" />
                                        </td>
                                        <td>
                                        <form method="post">
                                            <input type="hidden" name="id" value="<?php echo "$records[Id]"; ?>" />
                                            <input name="deletehotelbooking" type="submit" value="Delete" class = "btn btn-primary", style = "width:80px; font-size:13px" />
                                            </form>
                                        </td>
                                    </tr>                           
                                    </tbody>
