...
if(isset($_POST['bookhotel']))
{
    ...
    $bookhotel = "INSERT into hotelbooking (HotelName, Name, Email, Travelers, Rooms, RoomType, CheckIn, CheckOut, Amount) VALUES('$hotelname', '$name', '$email', '$travelers', '$rooms', '$roomtype', '$checkin', '$checkout', '$amount')";

    $execute = mysqli_query($connect, $bookhotel);
    ...
    {
        echo "<script type='text/javascript'>alert('Hotel has not been booked');</script>";
    } 
}
