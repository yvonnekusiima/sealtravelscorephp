                        ...
                        <div class="photo-gallery" style="background-color: transparent;">
                            ...
                            <div class="container">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="../Hotels/TheMonarchHotelU.php" style="text-decoration:none">
                                        <div class="card">
                                            <br />
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="../Hotels/MestilHotelU.php" style="text-decoration:none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align:center;font-size:100px"></i>
                                            <div class="card-body" style="text-align:center;font-weight:bold">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="../Hotels/TheOberoiU.php" style="text-decoration:none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align:center;font-size:100px"></i>
                                            <div class="card-body" style="text-align:center;font-weight:bold">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="../Hotels/KigaliMarriottHotelU.php" style="text-decoration:none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align:center;font-size:100px"></i>
                                            <div class="card-body" style="text-align:center;font-weight:bold">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="../Hotels/EkoHotelU.php" style="text-decoration:none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align:center;font-size:100px"></i>
                                            <div class="card-body" style="text-align:center;font-weight:bold">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="../Hotels/LagoonHotelU.php" style="text-decoration:none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align:center;font-size:100px"></i>
                                            <div class="card-body" style="text-align:center;font-weight:bold">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="../Hotels/Shangri-laHotelU.php" style="text-decoration:none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align:center;font-size:100px"></i>
                                            <div class="card-body" style="text-align:center;font-weight:bold">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="../Hotels/HotelBrusselsU.php" style="text-decoration:none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align:center;font-size:100px"></i>
                                            <div class="card-body" style="text-align:center;font-weight:bold">
