                        ...
                        <div class="photo-gallery" style="background-color: transparent;">
                            ...
                            <div class="container">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="../Hotels/TheMonarchHotelA.php" style="text-decoration:none">
                                        <div class="card">
                                            <br />
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="../Hotels/MestilHotelA.php" style="text-decoration:none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align:center;font-size:100px"></i>
                                            <div class="card-body" style="text-align:center;font-weight:bold">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="../Hotels/TheOberoiA.php" style="text-decoration:none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align:center;font-size:100px"></i>
                                            <div class="card-body" style="text-align:center;font-weight:bold">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="../Hotels/KigaliMarriottHotelA.php" style="text-decoration:none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align:center;font-size:100px"></i>
                                            <div class="card-body" style="text-align:center;font-weight:bold">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="../Hotels/EkoHotelA.php" style="text-decoration:none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align:center;font-size:100px"></i>
                                            <div class="card-body" style="text-align:center;font-weight:bold">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="../Hotels/LagoonHotelA.php" style="text-decoration:none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align:center;font-size:100px"></i>
                                            <div class="card-body" style="text-align:center;font-weight:bold">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="../Hotels/Shangri-laHotelA.php" style="text-decoration:none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align:center;font-size:100px"></i>
                                            <div class="card-body" style="text-align:center;font-weight:bold">
                                ...
                                <div class="col-md-6 col-lg-3 py-3">
                                    <a href="../Hotels/HotelBrusselsA.php" style="text-decoration:none">
                                        <div class="card">
                                            <br />
                                            <i class="fa fa-hotel" style="text-align:center;font-size:100px"></i>
                                            <div class="card-body" style="text-align:center;font-weight:bold">
