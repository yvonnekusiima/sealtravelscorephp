...
if(isset($_POST['adduser']))
{
    ...
    $adduser = "INSERT into users (Email, Username, Password, DateAdded) VALUES('$email', '$username', '$password', '$dateadded')";

    $execute = mysqli_query($connect, $adduser);
    ...
    if(isset($execute))
    {
        ...
        $mail->SMTPSecure = 'tls';
        $mail->Port = 587;
        $mail->Username = 'vonworkug@gmail.com';
        $mail->Password = 'vonworkug00!';
        $mail->setFrom("vonworkug@gmail.com", "VONWORK UG");
        $mail->addAddress("$email", "$username");
        $mail->addReplyTo("vonworkug@gmail.com", "VONWORK UG");
        $mail->isHTML(true);
        $mail->Subject = "Login Credentials";
        $mail->Body = "Your username is <b>$username</b> <br> Your password is <b>$password</b>";
        try {
            $mail->send();
            echo "Login Credentials sent";
        } catch (Exception $e) {
...
function autogeneratepassword($chars)
{
    $allowedchars = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcefghijklmnopqrstuvwxyz1234567890';
    return substr(str_shuffle($allowedchars), 0, $chars);
}
$autogeneratedpassword = autogeneratepassword(5);
                                        ...
                                        <div class="p-5">
                                            ...
                                            <!--ADD USER FORM-->
                                                            ...
                                                            <form method="post" class="user"> 
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="password" class="form-control" type="hidden" value="<?php echo $autogeneratedpassword; ?>" style="font-size:13px" />
                                                                </div>
