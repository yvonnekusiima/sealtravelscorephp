        ...
        <!-- End of Topbar -->
            ...
            <div class="card-body">
              <div class="table-responsive">
                  ...
                  <input name="userrecords" type="submit" class = "btn btn-primary" value="Click to view administrator activity log" style="font-size:13px" /><br /><br />

                  <div class="form-group">
                        <input class="search pull-left" placeholder="Search for administrator activity" style="font-size:13px" />
                      <span class="counter pull-right"></span>
                        ...
                        <table class="table-hover table-bordered results">
                            ...
                            if (isset($_POST['administratoractivitylog']))
                            {
                                $connect = mysqli_connect("localhost", "root", "7762", "sealtravels");
                                
                                $administratoractivitylog = mysqli_query($connect, "SELECT * from administratoractivitylog");

                                while ($aal = mysqli_fetch_array($administratoractivitylog))
                                { 
                                    ?>
                                    ...
                                    <tr>
                                        <td>
                                            <?php  echo "$aal[AdministratorId]"; ?>
                                        </td> 
                                        <td>
                                            <?php echo "$aal[DateTimestamp]"; ?>
                                        </td>
                                        <td>
                                            <?php echo "$aal[Action]"; ?>
                                        </td>
                                        <td>
                                            <?php echo "$aal[IPAddress]"; ?>
                                        </td>
                                        <td>
                                            <?php echo "$aal[HostName]"; ?>
                                        </td>
                                    </tr>                           
                                    </tbody>
