...
if(isset($_POST['login']))
{
    ...
    $login = "SELECT * from administrator where AdministratorId='$administratorid' and Password='$password'";
                    ...
                    <div class="p-5">
                        ...
                        <form method="post" class="user">
                            <div class="form-group">
                                <input name="administratorid" class="form-control" type="text" placeholder="Administrator Id" required="required" style="font-size:13px" />
                            </div>
                            <div class="form-group">
                                <input name="password" class="form-control" type="password" placeholder="Password" required="required" style="font-size:13px" />
                            </div>
                            <div class="form-group">
                                <img src="AdministratorCaptcha.php" >
                            </div>
                            <div class="form-group">
