        ...
        <!-- End of Topbar -->
            ...
            <div class="card-body">
              <div class="table-responsive">
                  ...
                  <input name="userrecords" type="submit" class = "btn btn-primary" value="Click to view user activity log" style="font-size:13px" /><br /><br />
                  ...
                  <div class="form-group">
                      ...
                      <span class="counter pull-right"></span>
                        ...
                        <table class="table-hover table-bordered results">
                            ...
                            if (isset($_POST['useractivitylog']))
                            {
                                $connect = mysqli_connect("localhost", "root", "7762", "sealtravels");

                                $useractivitylog = mysqli_query($connect, "SELECT * from useractivitylog");

                                while ($ual = mysqli_fetch_array($useractivitylog))
                                {
                                    ?>
                            ...
                            <tr>
                                <td>
                                    <?php  echo "$ual[Username]"; ?>
                                </td>
                                <td>
                                    <?php echo "$ual[DateTimestamp]"; ?>
                                </td>
                                <td>
                                    <?php echo "$ual[Action]"; ?>
                                </td>
                                <td>
                                    <?php echo "$ual[IPAddress]"; ?>
                                </td>
                                <td>
                                    <?php echo "$ual[HostName]"; ?>
                                </td>
                            </tr>
                            </tbody>
