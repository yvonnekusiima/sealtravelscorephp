...
if(isset($_POST['changepassword']))
{
    ...
    $administratorid = trim($_POST['administratorid']);
    $newpassword = trim($_POST['newpassword']);

    $changepassword = "UPDATE administrator set Password = '$newpassword' where AdministratorId = '$administratorid'";

    $execute = mysqli_query($connect, $changepassword);
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="row">
                                    <div class="col-lg-5 d-none d-lg-block bg-gradient-primary">
                                        <h1 style="font-weight:700; margin-left:100px; margin-top:120px; color:white">Seal Travels <i class="fa fa-globe-americas"></i></h1>
                                    </div>
                                    <div class="col-lg-7">
                                        <div class="p-5">
                                            <div class="">
                                                <h4 class="" style="color:#4e73df; font-family:Heebo"><strong>Change Password</strong> <i class="fa fa-edit"></i></h4><br />
                                                            ...
                                                            <form method="post" class="user"> 
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="newpassword" class="form-control" type="password" placeholder="New Password" style="font-size:13px" />
                                                                </div>

                                                                <div>
                                                                    <input name="changepassword" type="submit" value="SAVE CHANGES" class="btn btn-primary btn-block" style="font-size:13px; font-weight:bold" />
                                                                </div>
